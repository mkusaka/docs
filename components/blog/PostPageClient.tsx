...
export function PostPageClient({ meta, rawContent, initialLanguage }: PostPageClientProps) {
        ...
        <div className="flex items-center gap-2 mb-8 text-[0.8125rem] text-muted-foreground min-h-[28px]">
          {generating ? (
            <>
              ...
              <span>Generating · {displayedModel}</span>
              <Button variant="outline" size="xs" onClick={handleStop} className="ml-auto">
                Stop
              </Button>
            </>
          ) : completion ? (
            <>
              <span className="text-muted-foreground">Generated by {displayedModel}</span>
              <Button variant="outline" size="xs" onClick={generate} className="ml-auto">
                Regenerate
              </Button>
            </>
          ) : null}
