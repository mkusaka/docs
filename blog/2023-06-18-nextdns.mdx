---
title: "NextDNSを使ってみて広告ブロックが捗ったので紹介"
date: 2023-06-18
description: "NextDNSを導入することで各種広告をdnsレベルでブロックできるようになったため、各種サイトのブラウジングが快適になった話"
categories: [tools]
...
## まとめ
- [NextDNS](https://nextdns.io/)は数年前にリリースされたdnsサービスで、各種広告などをdnsレベルでブロックすることが可能
- 個人的にここがすごいNextDNS
