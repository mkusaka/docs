    ...
    <div className="flex max-w-[1320px] mx-auto">
      ...
      <main className="flex-1 min-w-0 border-l border-white/[0.04] lg:border-l-0">
        <div className="max-w-[680px] mx-auto px-6 sm:px-8 pt-12 pb-32 relative">
          ...
          {/* Title */}
          <h1 className="text-[2.5rem] sm:text-5xl font-bold leading-[1.1] tracking-[-0.03em] mb-6 text-white">
            {post.title}
          </h1>

          {/* Subtitle */}
          {post.description && (
            <p className="text-lg text-neutral-400 leading-relaxed mb-6 max-w-[560px]">
              {post.description}
            </p>
          )}
